...
class MarketCalendar:
    ...
    def is_trading_day(self, check_date: Optional[Union[pd.Timestamp, datetime, date]] = None) -> bool:
    ...
    def next_trading_day(self, after_date: Optional[Union[datetime, date]] = None) -> Optional[date]:
    ...
    def prev_trading_day(self, before_date: Optional[Union[datetime, date]] = None) -> Optional[date]:
